...
To read the :value:`zoomSiteSpecific` setting:

.. code-block:: javascript

   let { value } = await messenger.browserSettings.zoomSiteSpecific.get({});

To update the :value:`zoomSiteSpecific` setting:

.. code-block:: javascript

   await messenger.browserSettings.zoomSiteSpecific.set({ value: <newValue> });

To clear the :value:`zoomSiteSpecific` setting and restore the default value:

.. code-block:: javascript

   await messenger.browserSettings.zoomSiteSpecific.clear({});
