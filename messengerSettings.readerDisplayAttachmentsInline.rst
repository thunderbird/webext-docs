...
To update the :value:`readerDisplayAttachmentsInline` setting:

.. code-block:: javascript

   await messenger.messengerSettings.readerDisplayAttachmentsInline.set({ value: <newValue> });

To clear the :value:`readerDisplayAttachmentsInline` setting and restore the default value:

.. code-block:: javascript

   await messenger.messengerSettings.readerDisplayAttachmentsInline.clear({});
