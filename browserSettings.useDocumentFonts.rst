...
To read the :value:`useDocumentFonts` setting:

.. code-block:: javascript

   let { value } = await messenger.browserSettings.useDocumentFonts.get({});

To update the :value:`useDocumentFonts` setting:

.. code-block:: javascript

   await messenger.browserSettings.useDocumentFonts.set({ value: <newValue> });

To clear the :value:`useDocumentFonts` setting and restore the default value:

.. code-block:: javascript

   await messenger.browserSettings.useDocumentFonts.clear({});
