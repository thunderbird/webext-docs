...
To read the :value:`mode` setting:

.. code-block:: javascript

   let { value } = await messenger.browserSettings.colorManagement.mode.get({});

To update the :value:`mode` setting:

.. code-block:: javascript

   await messenger.browserSettings.colorManagement.mode.set({ value: <newValue> });

To clear the :value:`mode` setting and restore the default value:

.. code-block:: javascript

   await messenger.browserSettings.colorManagement.mode.clear({});
