...
.. api-header::
   :label: Parameters for messenger.menus.onClicked.addListener(listener)
...
.. api-header::
   :label: Parameters for messenger.menus.onShown.addListener(listener)
...
.. api-header::
   :label: Parameters for messenger.menus.onHidden.addListener(listener)
