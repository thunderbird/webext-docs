...
To read the :value:`tlsVersionRestriction` setting:

.. code-block:: javascript

   let { value } = await messenger.privacy.network.tlsVersionRestriction.get({});

To update the :value:`tlsVersionRestriction` setting:

.. code-block:: javascript

   await messenger.privacy.network.tlsVersionRestriction.set({ value: <newValue> });

To clear the :value:`tlsVersionRestriction` setting and restore the default value:

.. code-block:: javascript

   await messenger.privacy.network.tlsVersionRestriction.clear({});
