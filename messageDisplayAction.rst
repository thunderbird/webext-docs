...
The messageDisplayAction API was added in Thunderbird 71. It is similar to Firefox's
`browserAction API`__ and can be combined with the :doc:`messageDisplay` API to determine the
