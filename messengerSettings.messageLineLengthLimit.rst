...
To update the :value:`messageLineLengthLimit` setting:

.. code-block:: javascript

   await messenger.messengerSettings.messageLineLengthLimit.set({ value: <newValue> });

To clear the :value:`messageLineLengthLimit` setting and restore the default value:

.. code-block:: javascript

   await messenger.messengerSettings.messageLineLengthLimit.clear({});
...
.. _messenger^settings.message^line^length^limit.clear:
...
.. api-header::
   ...
   .. _messenger^settings.message^line^length^limit.clear.details:

   .. api-member::
      :name: ``details``
      :refid: messenger-settings-message-line-length-limit-clear-details
      :refname: details
      :type: (object)

      Which setting to clear.

      .. _messenger^settings.message^line^length^limit.clear.details.scope:

      .. api-member::
         :name: [``scope``]
         :refid: messenger-settings-message-line-length-limit-clear-details-scope
         :refname: scope
         :type: (:ref:`messenger^settings.message^line^length^limit.^setting^scope`, optional)
...
.. _messenger^settings.message^line^length^limit.set:
...
.. api-header::
   ...
   .. _messenger^settings.message^line^length^limit.set.details:

   .. api-member::
      :name: ``details``
      :refid: messenger-settings-message-line-length-limit-set-details
      :refname: details
      :type: (object)

      Which setting to change.

      .. _messenger^settings.message^line^length^limit.set.details.value:

      .. api-member::
         :name: ``value``
         :refid: messenger-settings-message-line-length-limit-set-details-value
         :refname: value
         :type: (any)
      ...
      .. _messenger^settings.message^line^length^limit.set.details.scope:

      .. api-member::
         :name: [``scope``]
         :refid: messenger-settings-message-line-length-limit-set-details-scope
         :refname: scope
         :type: (:ref:`messenger^settings.message^line^length^limit.^setting^scope`, optional)
...
.. _messenger^settings.message^line^length^limit.^setting^scope:
...
.. api-header::
   ...
   .. container:: api-member-node
      ...
      .. container:: api-member-description-only
         ...
         .. _messenger^settings.message^line^length^limit.^setting^scope.incognito_persistent:

         .. api-member::
            :name: :value:`incognito_persistent`
            :refid: messenger-settings-message-line-length-limit-setting-scope-incognito-persistent
            :refname: incognito_persistent

         .. _messenger^settings.message^line^length^limit.^setting^scope.incognito_session_only:

         .. api-member::
            :name: :value:`incognito_session_only`
            :refid: messenger-settings-message-line-length-limit-setting-scope-incognito-session-only
            :refname: incognito_session_only

         .. _messenger^settings.message^line^length^limit.^setting^scope.regular:

         .. api-member::
            :name: :value:`regular`
            :refid: messenger-settings-message-line-length-limit-setting-scope-regular
            :refname: regular

         .. _messenger^settings.message^line^length^limit.^setting^scope.regular_only:

         .. api-member::
            :name: :value:`regular_only`
            :refid: messenger-settings-message-line-length-limit-setting-scope-regular-only
