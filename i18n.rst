...
.. note::
   ...
   Firefox 47 and earlier returns "??" instead of "" if the message is not found in _locales, `bug 1258199 <https://bugzil.la/1258199>`__ changed this act to match Chrome, landed on Firefox 48.
...
.. note::
   ...
   Firefox 55 and earlier returns a language tag that's separated with the underscore character instead of hyphen, see `bug 1374552 <https://bugzil.la/1374552>`__.
