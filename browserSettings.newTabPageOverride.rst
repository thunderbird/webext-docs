...
.. _browser^settings.new^tab^page^override.permission.browser^settings:

.. api-member::
   :name: :permission:`browserSettings`
   :refid: browser-settings-new-tab-page-override-permission-browser-settings
...
.. note::
   ...
   The permission :permission:`browserSettings` is required to use ``messenger.browserSettings.newTabPageOverride.*``.
...
To read the :value:`newTabPageOverride` setting:

.. code-block:: javascript

   let { value } = await messenger.browserSettings.newTabPageOverride.get({});

To update the :value:`newTabPageOverride` setting:

.. code-block:: javascript

   await messenger.browserSettings.newTabPageOverride.set({ value: <newValue> });

To clear the :value:`newTabPageOverride` setting and restore the default value:

.. code-block:: javascript

   await messenger.browserSettings.newTabPageOverride.clear({});
...
.. api-header::
   ...
   .. _browser^settings.new^tab^page^override.get.details:

   .. api-member::
      :name: ``details``
      :refid: browser-settings-new-tab-page-override-get-details
      :refname: details
      :type: (object)

      Which setting to consider.

      .. _browser^settings.new^tab^page^override.get.details.incognito:

      .. api-member::
         :name: [``incognito``]
         :refid: browser-settings-new-tab-page-override-get-details-incognito
         :refname: incognito
...
.. api-header::
   ...
   .. _browser^settings.new^tab^page^override.get.returns:

   .. api-member::
      :refid: browser-settings-new-tab-page-override-get-returns
      :refname: _returns
      :type: object

      Details of the currently effective value.

      .. _browser^settings.new^tab^page^override.get.returns.level^of^control:

      .. api-member::
         :name: ``levelOfControl``
         :refid: browser-settings-new-tab-page-override-get-returns-level-of-control
         :refname: levelOfControl
         :type: (:ref:`browser^settings.new^tab^page^override.^level^of^control`)

         The level of control of the setting.

      .. _browser^settings.new^tab^page^override.get.returns.value:

      .. api-member::
         :name: ``value``
         :refid: browser-settings-new-tab-page-override-get-returns-value
         :refname: value
         :type: (any)

         The value of the setting.

      .. _browser^settings.new^tab^page^override.get.returns.incognito^specific:

      .. api-member::
         :name: [``incognitoSpecific``]
         :refid: browser-settings-new-tab-page-override-get-returns-incognito-specific
...
.. _browser^settings.new^tab^page^override.on^change:
...
.. api-header::
   ...
   .. _browser^settings.new^tab^page^override.on^change.listener(details):

   .. api-member::
      :name: ``listener(details)``
      :refid: browser-settings-new-tab-page-override-on-change-listener-details
...
.. api-header::
   ...
   .. _browser^settings.new^tab^page^override.on^change.details:

   .. api-member::
      :name: ``details``
      :refid: browser-settings-new-tab-page-override-on-change-details
      :refname: details
      :type: (object)

      .. _browser^settings.new^tab^page^override.on^change.details.level^of^control:

      .. api-member::
         :name: ``levelOfControl``
         :refid: browser-settings-new-tab-page-override-on-change-details-level-of-control
         :refname: levelOfControl
         :type: (:ref:`browser^settings.new^tab^page^override.^level^of^control`)

         The level of control of the setting.

      .. _browser^settings.new^tab^page^override.on^change.details.value:

      .. api-member::
         :name: ``value``
         :refid: browser-settings-new-tab-page-override-on-change-details-value
         :refname: value
         :type: (any)

         The value of the setting after the change.

      .. _browser^settings.new^tab^page^override.on^change.details.incognito^specific:

      .. api-member::
         :name: [``incognitoSpecific``]
         :refid: browser-settings-new-tab-page-override-on-change-details-incognito-specific
         :refname: incognitoSpecific
         :type: (boolean, optional)
...
.. _browser^settings.new^tab^page^override.^level^of^control:
...
.. api-header::
   ...
   .. container:: api-member-node
      ...
      .. container:: api-member-description-only
         ...
         .. _browser^settings.new^tab^page^override.^level^of^control.controllable_by_this_extension:

         .. api-member::
            :name: :value:`controllable_by_this_extension`
            :refid: browser-settings-new-tab-page-override-level-of-control-controllable-by-this-extension
            :refname: controllable_by_this_extension

         .. _browser^settings.new^tab^page^override.^level^of^control.controlled_by_other_extensions:

         .. api-member::
            :name: :value:`controlled_by_other_extensions`
            :refid: browser-settings-new-tab-page-override-level-of-control-controlled-by-other-extensions
            :refname: controlled_by_other_extensions

         .. _browser^settings.new^tab^page^override.^level^of^control.controlled_by_this_extension:

         .. api-member::
            :name: :value:`controlled_by_this_extension`
            :refid: browser-settings-new-tab-page-override-level-of-control-controlled-by-this-extension
            :refname: controlled_by_this_extension

         .. _browser^settings.new^tab^page^override.^level^of^control.not_controllable:
