...
To read the :value:`homepageOverride` setting:

.. code-block:: javascript

   let { value } = await messenger.browserSettings.homepageOverride.get({});

To update the :value:`homepageOverride` setting:

.. code-block:: javascript

   await messenger.browserSettings.homepageOverride.set({ value: <newValue> });

To clear the :value:`homepageOverride` setting and restore the default value:

.. code-block:: javascript

   await messenger.browserSettings.homepageOverride.clear({});
...
.. _browser^settings.homepage^override.clear:
...
.. api-header::
   ...
   .. _browser^settings.homepage^override.clear.details:

   .. api-member::
      :name: ``details``
      :refid: browser-settings-homepage-override-clear-details
      :refname: details
      :type: (object)

      Which setting to clear.

      .. _browser^settings.homepage^override.clear.details.scope:

      .. api-member::
         :name: [``scope``]
         :refid: browser-settings-homepage-override-clear-details-scope
         :refname: scope
         :type: (:ref:`browser^settings.homepage^override.^setting^scope`, optional)
...
.. _browser^settings.homepage^override.set:
...
.. api-header::
   ...
   .. _browser^settings.homepage^override.set.details:

   .. api-member::
      :name: ``details``
      :refid: browser-settings-homepage-override-set-details
      :refname: details
      :type: (object)

      Which setting to change.

      .. _browser^settings.homepage^override.set.details.value:

      .. api-member::
         :name: ``value``
         :refid: browser-settings-homepage-override-set-details-value
         :refname: value
         :type: (any)
      ...
      .. _browser^settings.homepage^override.set.details.scope:

      .. api-member::
         :name: [``scope``]
         :refid: browser-settings-homepage-override-set-details-scope
         :refname: scope
         :type: (:ref:`browser^settings.homepage^override.^setting^scope`, optional)
...
.. _browser^settings.homepage^override.^setting^scope:
...
.. api-header::
   ...
   .. container:: api-member-node
      ...
      .. container:: api-member-description-only
         ...
         .. _browser^settings.homepage^override.^setting^scope.incognito_persistent:

         .. api-member::
            :name: :value:`incognito_persistent`
            :refid: browser-settings-homepage-override-setting-scope-incognito-persistent
            :refname: incognito_persistent

         .. _browser^settings.homepage^override.^setting^scope.incognito_session_only:

         .. api-member::
            :name: :value:`incognito_session_only`
            :refid: browser-settings-homepage-override-setting-scope-incognito-session-only
            :refname: incognito_session_only

         .. _browser^settings.homepage^override.^setting^scope.regular:

         .. api-member::
            :name: :value:`regular`
            :refid: browser-settings-homepage-override-setting-scope-regular
            :refname: regular

         .. _browser^settings.homepage^override.^setting^scope.regular_only:

         .. api-member::
            :name: :value:`regular_only`
            :refid: browser-settings-homepage-override-setting-scope-regular-only
