...
.. api-header::
   ...
   .. api-member::
      ...
      .. api-member::
         ...
         Set this to true if the file upload was aborted by the user and a :ref:`cloudFile.onFileUploadAbort` event has been received. No error message will be shown to the user.
