...
.. api-header::
   ...
   .. api-member::
      ...
      .. api-member::
         ...
         A string the browserAction button should display as its label and when moused over. Cleared by setting it to :value:`null` or an empty string (title defined the manifest will be used).
...
.. api-header::
   ...
   .. api-member::
      ...
      .. api-member::
         ...
         A string the browserAction button should use as its label, overriding the defined title. Can be set to an empty string to not display any label at all. If the containing toolbar is configured to display text only, its title will be used. Cleared by setting it to :value:`null`.
